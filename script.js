...
let users = {
    Administrador: {
        usuarios: {
            gabriel: "bolita10", // Nome de usuário e senha do Administrador
            souza1: "rredmgic", // Outro usuário do Administrador
        },
        Permissions: {
    ...
    Gerente: {
        usuarios: {
            gabriela: "bolita1", // Nome de usuário e senha do Gerente
            souzax: "rredmgisc", // Outro usuário do Gerente
        },
        Permissions: {
            view_veiculos: true, // Permissão para visualizar veículos
            view_armazem: true, // Permissão para visualizar armazém
    ...
    Funcionario: {
        usuarios: {
            teste: "teste", // Nome de usuário e senha do Funcionário
            souzac: "rredmgic2", // Outro usuário do Funcionário
        },
        Permissions: {
